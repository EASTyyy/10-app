(function () {
    ...
    window.GlobalConfig = {
        DPLUS_SITE_TOKEN: 'cd166347a3d60b98c303'
    };
    ...
    app.constant('Config',
        {
             ...
             */
            TEMPLATE_URL_PREFIX: 'https://yilinstyle-dev.img-cn-hangzhou.aliyuncs.com/client/template/',
            ...
            // 数据埋点服务器
            REPORT_URL: "http://report.dev.yilinstyle.com",
	         ...
	         * 分享域名
             */
            SHARE_HOSTNAME: "http://app.dev.yilinstyle.com/share"
        }
    );
