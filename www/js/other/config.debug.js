(function () {
    ...
    window.GlobalConfig = {
        DPLUS_SITE_TOKEN: 'e2160681a149ccdd2ced'
    };
    ...
    app.constant('Config',
        {
             ...
             */
            TEMPLATE_URL_PREFIX: 'https://yilinstyle-test.img-cn-hangzhou.aliyuncs.com/client/template/',
            ...
            // 数据埋点服务器
            REPORT_URL: "http://report.test.yilinstyle.com",
             ...
             * API访问地址
             */
            URL_PREFIX: 'https://app.test.yilinstyle.com/api/app/',
	         ...
	         * 分享域名
             */
            SHARE_HOSTNAME: "http://app.test.yilinstyle.com/share"
        }
    );
